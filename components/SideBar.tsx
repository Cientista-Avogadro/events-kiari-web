    ...
    >
      ...
      >
        ...
        <Flex
          ...
          cursor='pointer'
          style={{
            backgroundColor: Router.pathname === '/Events' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <MdOutlineEventNote />
        ...
        <Flex
          ...
          cursor='pointer'
          style={{
            backgroundColor: Router.pathname === '/Invicts' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <MdMoveToInbox />
        ...
        <Flex
          ...
          cursor='pointer'
          style={{
            backgroundColor: Router.pathname === '/schedule' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <BiCalendar />
        ...
        <Flex
          ...
          style={{
            backgroundColor:
              Router.pathname === '/SavedEvents' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <IoCubeSharp />
        ...
        <Flex
          ...
          cursor='pointer'
          style={{
            backgroundColor: Router.pathname === '/Services' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <MdMiscellaneousServices />
        ...
        <Flex
          ...
          cursor='pointer'
          style={{
            backgroundColor: Router.pathname === '/Settings' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            {' '}
        ...
        <Flex
          ...
          style={{
            backgroundColor:
              Router.pathname === '/AccountBank' ? '#512DA8' : '',
          }}
        >
          <Text fontSize={'20px'}>
            <BsBank />
